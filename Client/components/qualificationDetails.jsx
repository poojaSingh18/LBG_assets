...
export default class QualificationDetails extends React.Component {
  ...
  render() {
    console.log(JSON.stringify(this.props.qualificationProps));
    return (
      <div className="well">
        ...
        <div><span><b>Digital Academy Training Completed? :</b> </span> {this.props.digitalAcademyProps.trainingComplete}</div><br/>
        <div><span><b>Digital Academy Training Type :</b> </span> {this.props.digitalAcademyProps.trainingType}</div><br/>
        <div><span><b>Digital Academy Training Completion Date :</b> </span> {this.props.digitalAcademyProps.trainingCompletionDate}</div><br/>
